...
require_once('../../../../framework/nusoap/lib/nusoap.php');
	...
	if(isset($_GET['nue']))
	{
		...
		if(strlen($nue)<11){$str_number="51".$nue; }
		$nuetxt="&amp;nue=".$nue;
	}
...
<div id="page">
  ...
  <img src="img/destacado-nextel_150x70.jpg" width="150" alt="destacado_" /> 
  
  
  
  <a href="http://bip.pe/pe/mo/wap/ft/validacion.php?v=<?=$val_sms;?>&c=<?=$cd."".$nuetxt;?>" ><?=$valora["Tema"];?><span><?=$valora["Artista"];?></span></a>
...
?>	
  ...
  <div id="list-titulo-precio">Suscr&iacute;bete para descargar todas las canciones que quieras interdiario. Costo: US$0.50 interdiario.</div>
  ...
  <div id="list-musica">
    ...
    <div class="list-item"> <span class="numero"><?=$count;?>.</span> <a href="http://bip.pe/pe/mo/wap/ft/validacion.php?v=<?=$val_sms;?>&c=<?=$valora["CodigoRBT"]."".$nuetxt;?>"><?=$valora["Tema"];?> <span><?=$valora["Artista"];?></span></a>
      <div style="clear:both"></div>
    </div>
...
?>	
  ...
  <div id="footer"><a href="#">Legal</a></div>
</div>
</body>
</html>