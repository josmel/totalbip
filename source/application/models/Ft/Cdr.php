 ...
 * @author Josmel
 */
class Application_Model_Ft_Cdr extends App_Db_Table_Abstract {

	protected $_name = 'cdrFt';
	const TABLA_CDR = 'cdrFt';
	...
	private function saveCdrText($datos, $id) {
		...
		$name = date('YmdH');		 
		$writer = new Zend_Log_Writer_Stream(APPLICATION_PATH . '/../logs/cdr/ft/'.$name.".moso");
