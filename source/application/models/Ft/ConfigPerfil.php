 ...
 * @author Josmel
 */
class Application_Model_Ft_ConfigPerfil extends App_Db_Table_Abstract {

    protected $_name = 'perfilFt';

    const TABLA_CONFIG = 'perfilFt';
    const INTERMEDIO = '3';
    const SMART = '5';
    ...
    public function registerCdr($userAgent, $result, $link = NULL) {
    	...
    	$model = new Application_Model_Ft_Cdr();
