...
class Application_Entity_PooArwebRt {
    ...
    function getDestacado1() {
        ...
        $XMLString = file_get_contents('../xml/rt/' . $file);
    ...
    function getDestacado() {
        ...
        foreach ($HEADs as $HEAD) {
            ...
            foreach ($DESTACADOs as $DESTACADO) {
                ...
                $data[$i]["RUTAIMAGEN"] = str_replace("_ImagenesPortalWap/", "rt/destacado/", $RUTAIMAGEN->item(0)->nodeValue);
                $i++;
            }
        }
        return $data;
