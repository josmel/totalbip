...
function getPutsDescargaLOG($url,$id,$numero,$codigo_catalogo){
	if(isset($_SERVER['HTTP_X_UP_CALLING_LINE_ID']) && $_SERVER['HTTP_X_UP_CALLING_LINE_ID'] != ""){$str_number = $_SERVER['HTTP_X_UP_CALLING_LINE_ID'];}else{$str_number = $_GET['nu'];}
	$var_ .= $fecha = date( "Y-m-d" ) . ",";
	$var_ .= $hora = date( "H:i:s" ) . ",";
	$var_ .= $url . ",";
	$var_ .= $id . ",";
